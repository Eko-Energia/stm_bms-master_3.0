...
For work in this project, follow the shared AI guidance in [AI.md](AI.md).

Before producing code or documentation, read the task-specific document listed in `AI.md`. For hardware behavior, use `BMS-Master.ioc` as the source of truth and cross-check `docs/pcb.md`.
